...
class ehtecOptics (Workbench):
    ...
    def Initialize(self):
        ...
        import convert_to_lens, single_ray_laser # import here all the needed files that create your FreeCAD commands
        self.list = ["Convert_To_Lens", "Single_Ray_Laser"] # A list of command names created in the line above
